...
class Web {
  ...
  Logout() {
    ...
    this.GetDiscoveryDoc().then(docInfo => {
      const endSessionEndpoint = docInfo.DiscoveryDoc && docInfo.DiscoveryDoc.end_session_endpoint
      ...
      if (endSessionEndpoint) {
        ...
        console.warn('OpenID Connect end_session_endpoint not found. Falling back to local logout.')
